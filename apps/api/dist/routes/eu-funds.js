...
export const euFundsRoutes = async (fastify) => {
    const euFundsService = new EUFundsService();
    fastify.get("/eu-funds/projects/search", async (request, reply) => {
        try {
            const { query, program, region, municipality, minValue, maxValue, limit, } = request.query;
    ...
    fastify.get("/eu-funds/projects/summary/:municipality", async (request, reply) => {
        try {
    ...
    fastify.get("/eu-funds/competitions", async (request, reply) => {
        try {
    ...
    fastify.get("/eu-funds/competitions/upcoming", async (request, reply) => {
        try {
    ...
    fastify.get("/eu-funds/opportunities/:projectType", async (request, reply) => {
        try {
            const { projectType } = request.params;
            const opportunities = await euFundsService.findFundingOpportunities(projectType);
    ...
    fastify.get("/eu-funds/competitiveness", async (request, reply) => {
        try {
...
//# sourceMappingURL=eu-funds.js.map