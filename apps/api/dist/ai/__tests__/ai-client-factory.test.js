...
describe("AIClientFactory", () => {
    ...
    describe("getConfig", () => {
        ...
        it("powinien rzucić AIError gdy brak konfiguracji", async () => {
            ...
            await expect(factory.getConfig("user-123", "llm")).rejects.toThrow(AIError);
        });
    ...
    describe("różne typy klientów", () => {
        ...
        it("powinien utworzyć klienta Embeddings", async () => {
            ...
            expect(client).toBeDefined();
            expect(mockResolveFunction).toHaveBeenCalledWith("user-123", "embeddings");
        });
...
//# sourceMappingURL=ai-client-factory.test.js.map