    ...
    async getCouncilSessions(channelConfig, searchQuery) {
        ...
        try {
            ...
            if (sessions.length === 0) {
                console.log(`[YouTubeSessionService] No search results, falling back to channel: ${config.channelUrl}`);
                    ...
                    for (const tab of tabs) {
                        ...
                        for (const item of tabContent) {
                            ...
                            if (videoRenderer) {
                                ...
                                if (title.toLowerCase().includes("sesja") ||
