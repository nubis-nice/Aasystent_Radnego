...
class DocumentProcessQueue {
    ...
    async initialize() {
        ...
        this.queue = new Queue("document-process-jobs", {
        ...
        this.queueEvents.on("completed", async ({ jobId, returnvalue }) => {
            ...
            await this.updateJobStatus(jobId, "completed", returnvalue);
            ...
            backgroundTaskService
                ...
                .catch((err) => console.error("[DocumentProcessQueue] Background task error:", err));
        });
        this.queueEvents.on("failed", async ({ jobId, failedReason }) => {
            console.log(`[DocumentProcessQueue] ❌ Job ${jobId} failed: ${failedReason}`);
        ...
        console.log(`[DocumentProcessQueue] Initialized (redis=${redisHost}:${redisPort})`);
    }
    /**
    ...
    async addJob(data) {
        ...
        backgroundTaskService
            ...
            .catch((err) => console.error("[DocumentProcessQueue] Background task error:", err));
        console.log(`[DocumentProcessQueue] Added job ${jobId} for ${data.fileName}`);
...
export async function addDocumentProcessJob(data) {
    return documentProcessQueue.addJob(data);
}
export async function getUserDocumentJobs(userId, limit) {
    return documentProcessQueue.getUserJobs(userId, limit);
}
export async function getDocumentJob(jobId, userId) {
    return documentProcessQueue.getJob(jobId, userId);
}
export async function deleteDocumentJob(jobId, userId) {
    return documentProcessQueue.deleteJob(jobId, userId);
}
export async function retryDocumentJob(jobId, userId) {
...
//# sourceMappingURL=document-process-queue.js.map