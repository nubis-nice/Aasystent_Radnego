...
export async function gusRoutes(fastify: FastifyInstance) {
  ...
  }>("/gus/gmina/search", async (request, reply) => {
    const userId = request.headers["x-user-id"] as string;
  ...
  }>("/gus/gmina/:id/stats", async (request, reply) => {
    const userId = request.headers["x-user-id"] as string;
  ...
  }>("/gus/variables", async (request, reply) => {
    const userId = request.headers["x-user-id"] as string;
  ...
  }>("/gus/subjects", async (request, reply) => {
    const userId = request.headers["x-user-id"] as string;
  ...
  }>("/gus/compare", async (request, reply) => {
    const userId = request.headers["x-user-id"] as string;
  ...
  }>("/gus/api-key", async (request, reply) => {
    const userId = request.headers["x-user-id"] as string;
