...
export const isapRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.get<{
    Params: { publisher: "DU" | "MP"; year: string };
  }>("/isap/acts/:publisher/:year", async (request, reply) => {
    try {
  ...
  }>("/isap/acts/search", async (request, reply) => {
    try {
      const {
        publisher,
        year,
  ...
  fastify.get<{
    Params: { publisher: "DU" | "MP"; year: string; position: string };
  }>("/isap/acts/:publisher/:year/:position", async (request, reply) => {
    try {
  ...
  fastify.get<{
    Params: { publisher: "DU" | "MP"; year: string; position: string };
  }>("/isap/acts/:publisher/:year/:position/text", async (request, reply) => {
    try {
      const { publisher, year, position } = request.params;
  ...
  fastify.get<{
    Params: { publisher: "DU" | "MP" };
    Querystring: { limit?: string };
  }>("/isap/latest/:publisher", async (request, reply) => {
    try {
  ...
  }>("/isap/local-government", async (request, reply) => {
    try {
