...
export interface ChatMessage {
  ...
  content: string;
  images?: string[]; // Base64 lub URL dla vision
}
...
// ═══════════════════════════════════════════════════════════════════════════
// Interfejsy klientów (abstrakcje)
// ═══════════════════════════════════════════════════════════════════════════
...
export class AIError extends Error {
  constructor(
    ...
    public functionType: AIFunctionType,
    public cause?: Error
  ) {
    super(message);
    this.name = "AIError";
