...
export const PRESETS: Record<PresetId, ConfigPreset> = {
  // ─────────────────────────────────────────────────────────────────────────
  ...
  ollama: {
    ...
    name: "Ollama (Local)",
    description:
      "Lokalne modele AI - Llama, Mistral, nomic-embed + faster-whisper",
    functions: {
      llm: {
        name: "Ollama LLM",
        provider: "ollama",
      ...
      tts: {
        ...
        endpoint: "/api/tts",
        defaultModel: "pl_PL-gosia-medium",
        authMethod: "none",
        requiresApiKey: false,
      },
    },
...
export const API_PROTOCOLS = {
  openai_compatible: {
    ...
    description:
      "Standard OpenAI API (Ollama, vLLM, LM Studio, Together, Groq...)",
  },
  anthropic: {
    name: "Anthropic",
 ...
 */
export function getPreset(presetId: PresetId): ConfigPreset {
 ...
 */
export function getPresetFunction(
  presetId: PresetId,
  functionType: AIFunctionType
): AIFunctionConfig | undefined {
 ...
 */
export function presetSupportsFunction(
  presetId: PresetId,
  functionType: AIFunctionType
): boolean {
 ...
 */
export const AI_FUNCTIONS: AIFunctionType[] = [
  "llm",
  "embeddings",
  "vision",
  "stt",
 ...
 */
export const AI_FUNCTION_NAMES: Record<AIFunctionType, string> = {
  llm: "LLM (Chat)",
