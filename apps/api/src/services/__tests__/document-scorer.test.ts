...
describe("DocumentScorer", () => {
  ...
  describe("calculateScore", () => {
    ...
    it("should add keyword bonus for priority keywords", () => {
      ...
      expect(scoreWith.relevanceScore).toBeGreaterThan(
        scoreWithout.relevanceScore,
      );
    ...
    it("should add location bonus for council location", () => {
      ...
      expect(scoreWith.scoringDetails.keywordBonus).toBeGreaterThanOrEqual(
        scoreWithout.scoringDetails.keywordBonus,
      );
    });
    ...
    it("should add urgency bonus for urgent keywords", () => {
      ...
      expect(urgentScore.urgencyScore).toBeGreaterThan(
        normalScore.urgencyScore,
      );
    });
