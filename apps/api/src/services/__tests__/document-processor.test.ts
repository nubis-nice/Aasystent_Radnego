...
describe("DocumentProcessor", () => {
  ...
  describe("Processing methods", () => {
    it("powinien obsługiwać metodę OCR", () => {
      const method: ProcessedDocument["metadata"]["processingMethod"] = "ocr";
      expect(method).toBe("ocr");
    });

    it("powinien obsługiwać metodę text-extraction", () => {
      const method: ProcessedDocument["metadata"]["processingMethod"] =
        "text-extraction";
    ...
    it("powinien obsługiwać metodę stt", () => {
      const method: ProcessedDocument["metadata"]["processingMethod"] = "stt";
